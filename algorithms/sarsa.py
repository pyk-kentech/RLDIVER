"""Tabular SARSA for the underwater fishing MDP."""
...
def train_sarsa(
    ...
    SARSA is on-policy: the bootstrap target uses the next action sampled from
    the same epsilon-greedy behavior policy that generated the transition.
    """
        ...
        while not done:
            ...
            if done:
                ...
                next_action = epsilon_greedy_action(
                    Q, next_state, valid_next_actions, epsilon
                )
