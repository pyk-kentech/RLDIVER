"""Run VI, SARSA, and Q-learning on the same reduced MDP.

This script is intentionally standalone. It lets the report compare all three
methods on one tractable reduced environment, while the main project can still
train SARSA and Q-learning on the full 11x11 environment.
"""
